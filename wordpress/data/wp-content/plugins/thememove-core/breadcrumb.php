...
class thememove_bread_crumb {
	...
	public function tm_bread_crumb( $args = '' ) {
		...
		$default = array(
			'type'             => 'list',
			'home_label'       => __( 'Home', 'tm-core' ),
			'search_label'     => __( 'Search Result of "%s"', 'tm-core' ),
			'404_label'        => __( '404 Not Found', 'tm-core' ),
			'category_label'   => _x( '%s', 'category label', 'tm-core' ),
			'tag_label'        => _x( '%s', 'tag label', 'tm-core' ),
			'taxonomy_label'   => _x( '%s', 'taxonomy label', 'tm-core' ),
			'author_label'     => _x( '%s', 'author label', 'tm-core' ),
			'attachment_label' => _x( '%s', 'attachment label', 'tm-core' ),
			'year_label'       => _x( '%s', 'year label', 'tm-core' ),
			'month_label'      => _x( '%s', 'month label', 'tm-core' ),
			'day_label'        => _x( '%s', 'day label', 'tm-core' ),
			'post_type_label'  => _x( '%s', 'post type label', 'tm-core' ),
			'joint_string'     => __( ' &gt; ', 'tm-core' ),
			'navi_element'     => '',
