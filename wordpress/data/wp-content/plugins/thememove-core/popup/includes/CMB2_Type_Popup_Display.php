...
class CMB2_Type_Popup_Display {
	...
	public function __construct() {
		add_action( 'cmb2_render_popup_display', array( $this, 'thememove_cmb2_render_popup_display' ), 10, 5 );
		add_filter( 'cmb2_sanitize_popup_display', array( $this, 'thememove_cmb2_sanitize_popup_display' ), 12, 4 );
	}
	 ...
	 */
	public function thememove_cmb2_render_popup_display( $field, $value, $object_id, $object_type, $field_type_object ) {
		...
		<div class="input-row">
			<label>
				...
				<?php echo esc_html__( 'Appear after', 'tm-core' ); ?>
			</label>
			<span class="opt-display-delay">
				...
				<?php echo esc_html__( 'Seconds', 'tm-core' ) ?>
			</span>
		</div>
		<div class="input-row">
			<label>
			...
			<?php echo esc_html__( 'of the page has been scrolled.', 'tm-molly' ); ?>
		</div>
		<div class="input-row">
			<label>
				<input type="radio" name="<?php echo esc_attr__( $field_type_object->_name( '[type]' ) ); ?>"
				       ...
				       style="">
				<?php echo esc_html__( 'Appear after user scrolled until CSS selector', 'tm-core' ); ?>
			</label>
	...
	public function thememove_cmb2_sanitize_popup_display( $override_value, $value, $object_id, $field_args ) {
